      ...
      foreach (var otherLocation in otherCharLocations)
      {
        ...
        if (val.Item1 + xDifference >= 0 && val.Item1 + xDifference <= maxX)
          if (val.Item2 + yDifference >= 0 && val.Item2 + yDifference <= maxY)
            result.Add((val.Item1 + xDifference, val.Item2 + yDifference, values.First(x => x.Item1 == val.Item1 + xDifference && x.Item2 == val.Item2 + yDifference).Item3));
        ...
        if (otherLocation.Item1 + secondXDifference >= 0 && otherLocation.Item1 + secondXDifference <= maxX)
          if (otherLocation.Item2 + secondYDifference >= 0 && otherLocation.Item2 + secondYDifference <= maxY)
            result.Add((otherLocation.Item1 + secondXDifference, otherLocation.Item2 + secondYDifference, values.First(x => x.Item1 == otherLocation.Item1 + secondXDifference && x.Item2 == otherLocation.Item2 + secondYDifference).Item3));
      }
    }
